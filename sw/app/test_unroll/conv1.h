...
#define CONV1_OUTPUTS_HEIGHT_NOPAD (CONV1_CHANNELS_HEIGHT - CONV1_KERNEL_HEIGHT + CONV1_STRIDE_Y) / CONV1_STRIDE_Y
#define CONV1_OUTPUTS_WIDTH_NOPAD (CONV1_CHANNELS_WIDTH - CONV1_KERNEL_WIDTH + CONV1_STRIDE_X) / CONV1_STRIDE_X
